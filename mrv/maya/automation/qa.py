...
"""
from mrv.automation.qa import QACheckResult
import mrv.automation.qa
...
class QAMELCheckAttribute( mrv.automation.qa.QACheckAttribute ):
    """Attribute identifying a MEL check carrying additional mel specific attributes"""
    pass


class QAMELCheck( mrv.automation.qa.QACheck ):
...
class QAMetaMel( mrv.dge._NodeBaseCheckMeta ):
...
class QAMELMixin( object ):
    ...
    def handleMELCheck( self, check, mode ):
        ...
        @throws RuntimeError If MEL throws an error
