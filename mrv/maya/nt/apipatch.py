...
class MPlug( api.MPlug ):
    ...
    def mchildByName( self, childname ):
        ...
        @throws AttributeError if no child plug of the appropriate name could be found
        @throws TypeError self is not a compound plug"""
    ...
    def mconnectTo( self, destplug, force=True ):
        ...
        @throws RuntimeError If destination is already connected and force = False"""
        mod = undo.DGModifier( )
