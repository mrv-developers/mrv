...
class FileReference(iDagItem):
    ...
    def create(cls, filepath, namespace=None, load = True, **kwargs):
        ...
        @throws ValueError if the namespace does already exist
        @throws RuntimeError if the reference could not be created"""
    ...
    def setNamespace(self, namespace):
        ...
        @throws RuntimeError if namespace already exists or if reference is not root
        @return self"""
        shortname = namespace
