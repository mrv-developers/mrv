#-*-coding:utf-8-*-
"""
@package mrv.automation.process
@brief Contains base class and common methods for all processes
...
class ProcessBase( mrv.dge.NodeBase ):
    ...
    @note the process base is able to duplicate properly as it stores in constructor
    ...
    def __init__( self, id, *args, **kwargs ):
        ...
        self._args = args
        self._kwargs = kwargs
        mrv.dge.NodeBase.__init__( self, id = id, *args, **kwargs )     # init last - need our info first !
    ...
    def targetRating( self, target, check_input_plugs = True, **kwargs ):
        ...
        @param kwargs
        @throws TypeError if the result is ambiguous and raise_on_ambiguity = 1"""
    ...
    def evaluateState( self, plug, mode ):
        ...
        - **target_state**
          + your return value must represent the _should_ state - thus you must assure
...
class WorkflowProcessBase( mrv.dgfe.GraphNodeBase, ProcessBase ):
    ...
    ## if true, all plugs that are connected will be pruned
    exclude_connected_plugs = True
    ## we load our copies directly and thus have a copy
    ...
    def __init__( self, id, wflInstance=None, **kwargs ):
        ...
        # init bases
        mrv.dgfe.GraphNodeBase.__init__( self, wrappedwfl, **kwargs )
