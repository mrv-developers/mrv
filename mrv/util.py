...
def decodeString(valuestr):
    ...
    @throws TypeError if the type could not be determined"""
...
class WeakInstFunction(object):
    ...
    def __call__(self, *args, **kwargs):
        """
        @throws LookupError if the instance referred to by the instance method
...
class EventSender(object):
    ...
    def sender(self):
        ...
        @throws ValueError if no event is currently in progress"""
...
class InterfaceMaster(mrv.interface.iDuplicatable):
    ...
    def setInterface(self, interfaceName, interfaceInstance):
        ...
        @throws ValueError if given InterfaceBase has a master already """
    ...
    def interface(self, interfaceName):
        ...
        @throws ValueError if no such interface exists"""
        try:
...
class PipeSeparatedFile(object):
    ...
    def readColumnLine(self):
        ...
        @throws ValueError if the column count changes between the lines"""
    ...
    def writeTokens(self, tokens):
        ...
        @throws TypeError If column count changed between successive calls"""
