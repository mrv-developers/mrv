...
class Element(object):
    ...
    def _checkType( self, other ):
        """@throws TypeError if other cannot be used with this element"""
    ...
    def __or__( self, other ):
        ...
        @throws TypeError if we are not a bitflag or other is not an element of our enumeration"""
        self._checkType( other )
        self._checkBitflag()
    ...
    def __and__( self, other ):
        ...
        @throws TypeError if other is not an int"""
...
class Enumeration(tuple):
    ...
    def nameFromValue(self, value):
        ...
        @throws ValueError if value is not a part of our enumeration"""
        try:
    ...
    def next( self, element, wrap_around = False ):
        ...
        @param wrap_around if True, the first Element will be returned if there is
            no next element
        @throws ValueError if wrap_around is False and there is no next element"""
    ...
    def previous( self, element, wrap_around = False ):
        ...
        @throws ValueError if wrap_around is False and there is no previous element"""
        return self._nextOrPrevious( element, -1, wrap_around )
